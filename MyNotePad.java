...
public class MyNotePad extends JFrame {
    ...
    MyNotePad(){
        ...
        area.setSize((int)width-20,(int)height-20);
        area.setLineWrap(true);
        JScrollPane js = new JScrollPane(area);
        JScrollPane jb = new JScrollPane(area);
        js.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
        js.setSize(20,(int)height-90);
        jb.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        js.setLocation((int)width-20,0);
        jb.setSize((int)width-10,20);
        jb.setLocation(0,(int)height-20);
        // area.add(js);
        f.add(js);
        f.add(jb);
        f.add(area);
